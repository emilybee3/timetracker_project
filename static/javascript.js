      ...
      var heatmapChart = function(tsvfile) { //makes objects from data
        d3.tsv("/static/data3.tsv",
        function(d) {
           console.log("d", d);
          var joel = {
            day: +d.day,
        ...
        function(error, data) { // console.log("ed", error, data);
          // var colorScale = d3.scale.ordinal() //function that converts input data into discrete buckets for output visualization
          //     .domain(["red", "yellow", "green"]) //range of possible values
          //     .range(colors); //possible output values
